graph TD;
    ...
    subgraph SourceSystem["Source System"]
        C_Repo[(Documentum Repository)]
    end

    subgraph MigrationTool["Migration Tool"]
        D[Export Module]
        E{Import Module}
    ...
    subgraph TargetSystems["Target Systems"]
        H_SP[(SharePoint)]
    ...
    style MigrationTool fill:#f9f,stroke:#333,stroke-width:2px;
